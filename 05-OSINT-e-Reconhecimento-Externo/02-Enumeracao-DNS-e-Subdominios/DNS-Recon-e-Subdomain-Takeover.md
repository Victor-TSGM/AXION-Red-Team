...
___
## 🎯 Ações Pendentes
- [ ] Implementar saída em formato JSON no script próprio para integração futura.
- [ ] Criar uma wordlist customizada com os principais provedores vulneráveis a Takeover.
